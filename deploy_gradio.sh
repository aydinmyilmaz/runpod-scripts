...
echo ""
echo "🚀 To start Gradio app:"
echo "   source venv/bin/activate"
echo "   export HF_HUB_ENABLE_HF_TRANSFER=1"
echo "   export PORT=8004"
echo "   python examples/app.py"
echo ""
echo "📝 Or run in tmux (background):"
echo "   tmux new-session -d -s gradio_app bash -c '"
echo "     source venv/bin/activate &&"
echo "     cd /workspace/Chatterbox-Multilingual-TTS &&"
echo "     export HF_HUB_ENABLE_HF_TRANSFER=1 &&"
echo "     export PORT=8004 &&"
echo "     python examples/app.py 2>&1 | tee /workspace/gradio.log"
echo "   '"
echo ""
echo "🔍 To check logs:"
